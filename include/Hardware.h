...
public:
    ...
    // Intake motors
    vex::motor intake_bottoom = vex::motor(vex::PORT6, vex::ratio6_1, false);
    ...
    vex::motor_group intake = vex::motor_group(intake_bottoom, intake_middle_left, intake_middleR_right, intake_top); //Use this
};